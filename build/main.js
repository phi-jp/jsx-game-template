...
function _Main$main$AS(args) {
	...
	app = new TouchNumberApp((function ($v) {
		if (! ($v == null || $v instanceof HTMLCanvasElement)) {
			debugger;
			throw new Error("[src/main.jsx:26:44] detected invalid cast, value is not an instance of the designated type or null\n        var app = new TouchNumberApp(canvas as HTMLCanvasElement);\n                                            ^^\n");
		}
		return $v;
	}(canvas)));
...
function dom$id$S(id) {
	return (function ($v) {
		if (! ($v == null || $v instanceof HTMLElement)) {
			debugger;
			throw new Error("[/Users/uematsu.yuki/Dropbox/git/jsx-game-template/node_modules/grunt-jsx/node_modules/jsx/lib/js/js/web.jsx:29:47] detected invalid cast, value is not an instance of the designated type or null\n        return dom.document.getElementById(id) as HTMLElement;\n                                               ^^\n");
		}
		return $v;
...
function dom$getElementById$S(id) {
	return (function ($v) {
		if (! ($v == null || $v instanceof HTMLElement)) {
			debugger;
			throw new Error("[/Users/uematsu.yuki/Dropbox/git/jsx-game-template/node_modules/grunt-jsx/node_modules/jsx/lib/js/js/web.jsx:37:47] detected invalid cast, value is not an instance of the designated type or null\n        return dom.document.getElementById(id) as HTMLElement;\n                                               ^^\n");
		}
		return $v;
	}(dom.document.getElementById(id)));
};
...
function dom$createElement$S(tag) {
	return (function ($v) {
		if (! ($v == null || $v instanceof HTMLElement)) {
			debugger;
			throw new Error("[/Users/uematsu.yuki/Dropbox/git/jsx-game-template/node_modules/grunt-jsx/node_modules/jsx/lib/js/js/web.jsx:45:47] detected invalid cast, value is not an instance of the designated type or null\n        return dom.document.createElement(tag) as __noconvert__ HTMLElement;\n                                               ^^\n");
		}
		return $v;
...
function Canvas() {
	...
	this.init$LHTMLCanvasElement$((function ($v) {
		if (! ($v == null || $v instanceof HTMLCanvasElement)) {
			debugger;
			throw new Error("[plugins/tmlib.jsx/src/graphics/canvas.jsx:18:22] detected invalid cast, value is not an instance of the designated type or null\n        this.init(elm as HTMLCanvasElement);\n                      ^^\n");
		}
		return $v;
	}(elm)));
};
...
Canvas.prototype.init$LHTMLCanvasElement$ = function (elm) {
	...
	this.context = (function ($v) {
		if (! ($v == null || $v instanceof CanvasRenderingContext2D)) {
			debugger;
			throw new Error("[plugins/tmlib.jsx/src/graphics/canvas.jsx:27:52] detected invalid cast, value is not an instance of the designated type or null\n        this.context = this.canvas.getContext(\'2d\') as CanvasRenderingContext2D;\n                                                    ^^\n");
		}
		return $v;
	...
	if (element instanceof Sprite) {
		this._drawSprite$LSprite$LCanvas$((function ($v) {
			if (! ($v == null || $v instanceof Sprite)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/display/renderer.jsx:34:37] detected invalid cast, value is not an instance of the designated type or null\n            this._drawSprite(element as Sprite, canvas);\n                                     ^^\n");
			}
			return $v;
		}(element)), canvas);
		...
		this._drawLabel$LLabel$LCanvas$((function ($v) {
			if (! ($v == null || $v instanceof Label)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/display/renderer.jsx:37:36] detected invalid cast, value is not an instance of the designated type or null\n            this._drawLabel(element as Label, canvas);\n                                    ^^\n");
			}
			return $v;
		}(element)), canvas);
		...
		this._drawShape$LShape$LCanvas$((function ($v) {
			if (! ($v == null || $v instanceof Shape)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/display/renderer.jsx:40:36] detected invalid cast, value is not an instance of the designated type or null\n            this._drawShape(element as Shape, canvas);\n                                    ^^\n");
			}
			return $v;
		}(element)), canvas);
		...
		canvaselement = (function ($v) {
			if (! ($v == null || $v instanceof CanvasElement)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/display/renderer.jsx:43:40] detected invalid cast, value is not an instance of the designated type or null\n            var canvaselement = element as CanvasElement;\n                                        ^^\n");
			}
			return $v;
		}(element));
	...
	Object.keys(assets).forEach((function (key) {
		...
		image = (function ($v) {
			if (! ($v == null || $v instanceof HTMLImageElement)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/asset/assetmanager.jsx:16:58] detected invalid cast, value is not an instance of the designated type or null\n            var image = dom.document.createElement(\"img\") as HTMLImageElement;\n                                                          ^^\n");
			}
			return $v;
		...
		image.src = (function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/asset/assetmanager.jsx:18:24] null access\n            image.src = value;\n                        ^^^^^\n");
			}
			return v;
		}(value));
...
function AssetManager$getImage$S(key) {
	return (function ($v) {
		if (! ($v == null || $v instanceof HTMLImageElement)) {
			debugger;
			throw new Error("[plugins/tmlib.jsx/src/asset/assetmanager.jsx:28:40] detected invalid cast, value is not an instance of the designated type or null\n        return AssetManager.assets[key] as HTMLImageElement;\n                                        ^^\n");
		}
		return $v;
	...
	if (this.children.length > 0) {
		this.children.forEach((function (elm) {
			(function ($v) {
				if (! ($v == null || $v instanceof CanvasElement)) {
					debugger;
					throw new Error("[plugins/tmlib.jsx/src/display/canvaselement.jsx:22:21] detected invalid cast, value is not an instance of the designated type or null\n                (elm as CanvasElement)._draw(ctx);\n                     ^^\n");
				}
				return $v;
...
Label.prototype._updateFontStyle$ = function () {
	this._fontStyle = Util$format$SHX("{_fontWeight} {_fontSize}px {_fontFamily}", (function ($v) {
		if (! ($v == null || typeof $v === "object" || typeof $v === "function")) {
			debugger;
			throw new Error("[plugins/tmlib.jsx/src/display/label.jsx:52:101] detected invalid cast, value is not a Map or null\n        this._fontStyle = Util.format(\"{_fontWeight} {_fontSize}px {_fontFamily}\", (this as variant) as Map.<variant>);\n                                                                                                     ^^\n");
		}
		return $v;
	}(this)));
	return this;
...
function GameScene() {
	...
	Util$shuffle$AX((function ($v) {
		if (! ($v == null || $v instanceof Array)) {
			debugger;
			throw new Error("[src/main.jsx:69:60] detected invalid cast, value is not an Array or null\n        Util.shuffle( (this.pieceGroup.children as variant) as Array.<variant> );\n                                                            ^^\n");
		}
		return $v;
		...
		for (j = 0; j < 5; ++ j) {
			...
			p = (function ($v) {
				if (! ($v == null || $v instanceof Object2D)) {
					debugger;
					throw new Error("[src/main.jsx:76:56] detected invalid cast, value is not an instance of the designated type or null\n                var p = this.pieceGroup.children[index] as Object2D;\n                                                        ^^\n");
				}
				return $v;
...
GameScene.prototype.checkTouch$X = function (app) {
	...
	baseApp = (function ($v) {
		if (! ($v == null || $v instanceof CanvasApp)) {
			debugger;
			throw new Error("[src/main.jsx:86:26] detected invalid cast, value is not an instance of the designated type or null\n        var baseApp = app as CanvasApp;\n                          ^^\n");
		}
		return $v;
	}(app));
	p = baseApp.pointing;
	...
	this.pieceGroup.children.forEach((function (elm) {
		...
		piece = (function ($v) {
			if (! ($v == null || $v instanceof Piece)) {
				debugger;
				throw new Error("[src/main.jsx:93:28] detected invalid cast, value is not an instance of the designated type or null\n            var piece = elm as Piece;\n                            ^^\n");
			}
			return $v;
		}(elm));
...
function Timer$setTimeout$F$V$N(callback, intervalMS) {
	return (function ($v) {
		if (! ($v == null || typeof $v === "function")) {
			debugger;
			throw new Error("[/Users/uematsu.yuki/Dropbox/git/jsx-game-template/node_modules/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:34:40] detected invalid cast, value is not a function or null\n        return (js.global[\"setTimeout\"] as __noconvert__ function(:function():void,:number) : TimerHandle)(callback, intervalMS);\n                                        ^^\n");
		}
		return $v;
...
function Timer$clearTimeout$LTimerHandle$(timer) {
	(function ($v) {
		if (! ($v == null || typeof $v === "function")) {
			debugger;
			throw new Error("[/Users/uematsu.yuki/Dropbox/git/jsx-game-template/node_modules/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:38:35] detected invalid cast, value is not a function or null\n        (js.global[\"clearTimeout\"] as __noconvert__ function(:TimerHandle) : void)(timer);\n                                   ^^\n");
		}
		return $v;
...
function Timer$setInterval$F$V$N(callback, intervalMS) {
	return (function ($v) {
		if (! ($v == null || typeof $v === "function")) {
			debugger;
			throw new Error("[/Users/uematsu.yuki/Dropbox/git/jsx-game-template/node_modules/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:42:41] detected invalid cast, value is not a function or null\n        return (js.global[\"setInterval\"] as __noconvert__ function(:function():void,:number) : TimerHandle)(callback, intervalMS);\n                                         ^^\n");
		}
		return $v;
...
function Timer$clearInterval$LTimerHandle$(timer) {
	(function ($v) {
		if (! ($v == null || typeof $v === "function")) {
			debugger;
			throw new Error("[/Users/uematsu.yuki/Dropbox/git/jsx-game-template/node_modules/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:46:36] detected invalid cast, value is not a function or null\n        (js.global[\"clearInterval\"] as __noconvert__ function(:TimerHandle) : void)(timer);\n                                    ^^\n");
		}
		return $v;
	...
	if (useNativeImpl) {
		...
		for (i = 0; i < prefixes.length; ++ i) {
			name = (function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[/Users/uematsu.yuki/Dropbox/git/jsx-game-template/node_modules/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:72:35] null access\n                var name = prefixes[i] + \"equestAnimationFrame\";\n                                   ^\n");
				}
				return v;
			...
			if (js$0.global[name] instanceof Function) {
				return (function (callback) {
					return (function ($v) {
						if (! ($v == null || typeof $v === "function")) {
							debugger;
							throw new Error("[/Users/uematsu.yuki/Dropbox/git/jsx-game-template/node_modules/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:75:48] detected invalid cast, value is not a function or null\n                        return (js.global[name] as __noconvert__\n                                                ^^\n");
						}
						return $v;
	...
	if (useNativeImpl) {
		...
		for (i = 0; i < prefixes.length; ++ i) {
			name = (function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[/Users/uematsu.yuki/Dropbox/git/jsx-game-template/node_modules/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:100:35] null access\n                var name = prefixes[i] + \"ancelAnimationFrame\";\n                                   ^\n");
				}
				return v;
			...
			if (js$0.global[name] instanceof Function) {
				return (function (timer) {
					(function ($v) {
						if (! ($v == null || typeof $v === "function")) {
							debugger;
							throw new Error("[/Users/uematsu.yuki/Dropbox/git/jsx-game-template/node_modules/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:103:41] detected invalid cast, value is not a function or null\n                        (js.global[name] as __noconvert__\n                                         ^^\n");
						}
						return $v;
...
function Mouse(elm) {
	...
	this.element.addEventListener("mousedown", (function (e) {
		...
		mouseEvent = (function ($v) {
			if (! ($v == null || $v instanceof MouseEvent)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/input/mouse.jsx:27:31] detected invalid cast, value is not an instance of the designated type or null\n            var mouseEvent = e as MouseEvent;\n                               ^^\n");
			}
			return $v;
		}(e));
	...
	this.element.addEventListener("mouseup", (function (e) {
		...
		mouseEvent = (function ($v) {
			if (! ($v == null || $v instanceof MouseEvent)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/input/mouse.jsx:31:31] detected invalid cast, value is not an instance of the designated type or null\n            var mouseEvent = e as MouseEvent;\n                               ^^\n");
			}
			return $v;
		}(e));
		$this.button &= ~ (1 << mouseEvent.button);
	...
	this.element.addEventListener("mousemove", (function (e) {
		...
		mouseEvent = (function ($v) {
			if (! ($v == null || $v instanceof MouseEvent)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/input/mouse.jsx:35:31] detected invalid cast, value is not an instance of the designated type or null\n            var mouseEvent = e as MouseEvent;\n                               ^^\n");
			}
			return $v;
		}(e));
		element = (function ($v) {
			if (! ($v == null || $v instanceof HTMLElement)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/input/mouse.jsx:36:35] detected invalid cast, value is not an instance of the designated type or null\n            var element = e.target as HTMLElement;\n                                   ^^\n");
			}
			return $v;
		}(e.target));
...
Mouse.prototype.getButton$S = function (button) {
	return (this.press & (function (v) {
		if (! (v != null)) {
			debugger;
			throw new Error("[plugins/tmlib.jsx/src/input/mouse.jsx:76:45] null access\n        return (this.press & Mouse.BUTTON_MAP[button]) != 0;\n                                             ^\n");
		}
		return v;
...
Mouse.prototype.getButtonDown$S = function (button) {
	return (this.down & (function (v) {
		if (! (v != null)) {
			debugger;
			throw new Error("[plugins/tmlib.jsx/src/input/mouse.jsx:80:44] null access\n        return (this.down & Mouse.BUTTON_MAP[button]) != 0;\n                                            ^\n");
		}
		return v;
	}(Mouse.BUTTON_MAP[button]))) !== 0;
};
...
Mouse.prototype.getButtonUp$S = function (button) {
	return (this.up & (function (v) {
		if (! (v != null)) {
			debugger;
			throw new Error("[plugins/tmlib.jsx/src/input/mouse.jsx:84:42] null access\n        return (this.up & Mouse.BUTTON_MAP[button]) != 0;\n                                          ^\n");
		}
		return v;
	}(Mouse.BUTTON_MAP[button]))) !== 0;
};
...
function Touch$0(elm) {
	...
	this.element.addEventListener("touchstart", (function (e) {
		...
		touchEvent = (function ($v) {
			if (! ($v == null || $v instanceof TouchEvent)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/input/touch.jsx:18:31] detected invalid cast, value is not an instance of the designated type or null\n            var touchEvent = e as TouchEvent;\n                               ^^\n");
			}
			return $v;
		}(e));
		element = (function ($v) {
			if (! ($v == null || $v instanceof HTMLElement)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/input/touch.jsx:19:35] detected invalid cast, value is not an instance of the designated type or null\n            var element = e.target as HTMLElement;\n                                   ^^\n");
			}
			return $v;
		}(e.target));
	...
	this.element.addEventListener("touchmove", (function (e) {
		...
		touchEvent = (function ($v) {
			if (! ($v == null || $v instanceof TouchEvent)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/input/touch.jsx:36:31] detected invalid cast, value is not an instance of the designated type or null\n            var touchEvent = e as TouchEvent;\n                               ^^\n");
			}
			return $v;
		}(e));
		element = (function ($v) {
			if (! ($v == null || $v instanceof HTMLElement)) {
				debugger;
				throw new Error("[plugins/tmlib.jsx/src/input/touch.jsx:37:35] detected invalid cast, value is not an instance of the designated type or null\n            var element = e.target as HTMLElement;\n                                   ^^\n");
			}
			return $v;
		}(e.target));
		t = touchEvent.touches[0];
...
$__jsx_lazy_init(dom, "document", function () {
	return (function ($v) {
		if (! ($v == null || $v instanceof HTMLDocument)) {
			debugger;
			throw new Error("[/Users/uematsu.yuki/Dropbox/git/jsx-game-template/node_modules/grunt-jsx/node_modules/jsx/lib/js/js/web.jsx:23:50] detected invalid cast, value is not an instance of the designated type or null\n    static const document = js.global[\"document\"] as __noconvert__ HTMLDocument;\n                                                  ^^\n");
		}
		return $v;
...
var $__jsx_classMap = {
	...
	"plugins/tmlib.jsx/src/geom/vector2.jsx": {
		Vector2: Vector2,
		Vector2$: Vector2,
		Vector2$NN: Vector2$0
	},
	"plugins/tmlib.jsx/src/util/util.jsx": {
		Util: Util,
		Util$: Util
	},
	"plugins/tmlib.jsx/src/app/baseapp.jsx": {
		BaseApp: BaseApp,
		BaseApp$LHTMLElement$: BaseApp
	},
	"plugins/tmlib.jsx/src/display/canvasapp.jsx": {
		CanvasApp: CanvasApp,
		CanvasApp$LHTMLCanvasElement$: CanvasApp
	},
	"plugins/tmlib.jsx/src/graphics/canvas.jsx": {
		Canvas: Canvas,
		Canvas$: Canvas,
		Canvas$LHTMLCanvasElement$: Canvas$0
	},
	"plugins/tmlib.jsx/src/display/renderer.jsx": {
		Renderer: Renderer,
		Renderer$: Renderer
	},
	"plugins/tmlib.jsx/src/asset/assetmanager.jsx": {
		AssetManager: AssetManager,
		AssetManager$: AssetManager
	},
	"plugins/tmlib.jsx/src/event/eventdispatcher.jsx": {
		Event: Event$0,
		Event$S: Event$0,
		EventDispatcher: EventDispatcher,
		EventDispatcher$: EventDispatcher
	},
	"plugins/tmlib.jsx/src/app/element.jsx": {
		Element: Element$0,
		Element$: Element$0
	},
	"plugins/tmlib.jsx/src/app/object2d.jsx": {
		Object2D: Object2D,
		Object2D$: Object2D
	},
	"plugins/tmlib.jsx/src/display/canvaselement.jsx": {
		CanvasElement: CanvasElement,
		CanvasElement$: CanvasElement
	},
	"plugins/tmlib.jsx/src/display/sprite.jsx": {
		Sprite: Sprite,
		Sprite$: Sprite,
		Sprite$S: Sprite$0
	},
	"plugins/tmlib.jsx/src/display/label.jsx": {
		Label: Label,
		Label$S: Label,
		Label$: Label$0
	},
	"plugins/tmlib.jsx/src/display/shape.jsx": {
		Shape: Shape,
		Shape$NN: Shape,
		Shape$N: Shape$0,
		Shape$: Shape$1
	},
	"plugins/tmlib.jsx/src/app/scene.jsx": {
		Scene: Scene,
		Scene$: Scene
	},
	...
	"plugins/tmlib.jsx/src/input/pointing.jsx": {
		Pointing: Pointing,
		Pointing$LHTMLElement$: Pointing
	},
	"plugins/tmlib.jsx/src/input/mouse.jsx": {
		Mouse: Mouse,
		Mouse$LHTMLElement$: Mouse
	},
	"plugins/tmlib.jsx/src/input/touch.jsx": {
		Touch: Touch$0,
		Touch$LHTMLElement$: Touch$0
	},
	"plugins/tmlib.jsx/src/util/flow.jsx": {
		Flow: Flow,
		Flow$IF$HXV$: Flow
	},
	"plugins/tmlib.jsx/src/geom/Vector2.jsx": {
